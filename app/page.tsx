          ...
          <div className="md:flex md:justify-between items-center pr-20">
            ...
            <p>Interaja clicando aqui ou na tela para liberar os efeitos sonoros!</p>
              ...
              <ul>
                  ...
                  >
                      <li onClick={TradePagesClick} onMouseEnter={TradePages} className="switch cursor-pointer text-xl p-8"><a>Home</a></li>
                      <li onClick={TradePagesClick} onMouseEnter={TradePages} className="switch cursor-pointer text-xl p-8"><a>Hamburgueres</a></li>
                      <li onClick={TradePagesClick} onMouseEnter={TradePages} className="switch cursor-pointer text-xl p-8"><a>Contact</a></li>
                  </div>
