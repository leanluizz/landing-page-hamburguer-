...
//Images
import Profile from '@/app/images/contact/Profile.jpg';
//Components
...
export default function Contact (){
    ...
    return(
        ...
        <a href="https://www.linkedin.com/in/leandroluizz/" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="rgb(10,102,194)" className="w-32 md:w-80 hover:animate-bounce md:m-10 m-2 botaoZoom cursor-pointer bi bi-linkedin" viewBox="0 0 16 16">
